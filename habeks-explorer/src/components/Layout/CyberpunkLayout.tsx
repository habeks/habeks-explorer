...
export const CyberpunkLayout: React.FC = () => {
  ...
  return (
    <div className="app">
      {/* ВЕРХНЯЯ НАВИГАЦИЯ - Табы (приоритет) */}
      ...
      {/* ПОЛНОЭКРАННАЯ КАРТА КАК ОСНОВА (самый низкий z-index) */}
      <div className="fullscreen-map-container" style={{ zIndex: 1 }}>
        {renderCurrentPage()}
      </div>
